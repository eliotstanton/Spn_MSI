...
scr1="/home/mdh/shared/Spn/Spn_fork/bLactam_MIC_Rscripts/AAtoMICwrapper_2.sh"
bash $scr1 $AAseqDir
...
scr1="/home/mdh/shared/Spn/Spn_fork/bLactam_MIC_Rscripts/MIC_format_with_SIR.R"
Rscript $scr1 $fin
